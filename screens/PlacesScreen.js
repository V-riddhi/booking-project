      ...
      properties: [
        {
          ...
          rating: 3.5,
          // image: "c:\Users\MTLAdmin\Downloads\367483881.jpg",
          address:
  ...
  return (
    <View>
      ...
      >
        ...
        >
          <Octicons name="arrow-switch" size={22} color="black" />
          <Text
            style={{
              fontSize: 15,
              fontWeight: "500",
      ...
      <BottomModal
        ...
        footer={
          <ModalFooter>
            <Pressable
              onPress={() => applyFiler(selectedFilter)}
              style={{
                paddingRight: 10,
                marginLeft: "auto",
                marginVertical: 10,
            ...
            >
              <Text style={{ textAlign: "center", justifyContent:"center" }}>Apply</Text>
            </Pressable>
          </ModalFooter>
        }
      ...
      >
        <ModalContent style={{ width: "100%", height: 200 }}>
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <Text style={{ textAlign: "center" }}>Sort and Filter</Text>
            </View>
            <View style={{ flex: 3, margin: 10 }}>
              {filters.map((item, index) => (
                ...
                >
                  ...
                  {/* <Entypo name="circle" size={18} color="black" /> */}
                  <Text
                    style={{ marginLeft: 5, fontWeight: "500", fontSize: 16 }}
                  >
                    {item.filter}
                  </Text>
                </Pressable>
